...
export class UiStyleToggleService {
  ...
  private isDarkThemeSelected(): boolean {
    this.darkThemeSelected = this._storage.get(this.THEME_KEY) === this.DARK_THEME_VALUE;
    return this.darkThemeSelected;
  }

  private setLightTheme() {
    this._storage.set(this.THEME_KEY, this.LIGHT_THEME_VALUE);
  ...
  private setDarkTheme() {
    this._storage.set(this.THEME_KEY, this.DARK_THEME_VALUE);
